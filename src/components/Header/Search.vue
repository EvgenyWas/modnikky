<template>
  <div class="search">
    <div
      ...
      :class="{ 'search__container--active': isSearchActive }"
    >
      <form
        :class="{ 'search__form--focused': isFocused }"
        class="search__form"
        @submit.prevent
        name="search"
      >
        <input
          ...
          @click="sortingOptions.setInactiveSearch"
        />
        <input
        ...
        <input
          ...
          :class="{ 'search__btn-search--active': true }"
          @click="handleSubmit"
        />
      </form>
    </div>
