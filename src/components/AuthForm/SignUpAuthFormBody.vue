<template>
  ...
  <sign-in-body
    :email="email"
    :password="password"
    :invalid-password-msg="invalidPasswordMsg"
  ...
  <div class="auth-form__subscribtion">
    ...
    <p class="auth-form__subscribtion-msg">
  ...
  <p class="auth-form__terms">
    ...
    <a href="#" class="auth-form__terms-link">Terms of Service</a> and
    <a href="#" class="auth-form__terms-link">Privacy Policy</a>
  </p>
</template>
